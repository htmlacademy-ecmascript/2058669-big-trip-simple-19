...
function createAddNewPointWithoutDestinationsTemplate() {
...
export default class AddNewPointWithoutDestinationsView {
  getTemplate() {
    return createAddNewPointWithoutDestinationsTemplate();
  }
